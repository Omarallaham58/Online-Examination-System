<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageStudents.aspx.cs" Inherits="ProjectV1.ManageStudents" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" 
            ...
            DeleteCommand="DELETE FROM [User] WHERE [id] = @original_id AND [account_id] = @original_account_id AND [firstName] = @original_firstName AND [lastName] = @original_lastName  AND [email] = @original_email AND (([phoneNumber] = @original_phoneNumber) OR ([phoneNumber] IS NULL AND @original_phoneNumber IS NULL))" 
            InsertCommand="INSERT INTO [User] ([id], [account_id], [firstName], [lastName], [dob], [email], [phoneNumber]) VALUES (@id, @account_id, @firstName, @lastName, @dob, @email, @phoneNumber)" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="0" Name="isTeacher" Type="Int32" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="firstName" Type="String" />
                <asp:Parameter Name="lastName" Type="String" />
        ...
        <div class="gridview-container">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="dob" HeaderText="dob" SortExpression="dob" DataFormatString="{0:yyyy-MM-dd}" ReadOnly="True" />
        ...
        <div class="button-container">
            <button><a href="AddStudent.aspx">Add a student</a></button>
